...
//      nomJNDI = "java:global/CabinetRecrutement/CabinetRecrutement_EJB/ServiceEntreprise!eu.telecom_bretagne.cabinet_recrutement.service.IServiceEntreprise";
      ...
      nomJNDI = "java:global/cabinet_recrutement-ear/eu.telecom_bretagne.cabinet_recrutement-cabinet_recrutement-web-1.0-SNAPSHOT/ServiceCandidature!eu.telecom_bretagne.cabinet_recrutement.service.IServiceCandidature";
    else if(nomEJB.equals("ServiceOffreemploi"))
      nomJNDI = "java:global/cabinet_recrutement-ear/eu.telecom_bretagne.cabinet_recrutement-cabinet_recrutement-web-1.0-SNAPSHOT/ServiceOffreemploi!eu.telecom_bretagne.cabinet_recrutement.service.IServiceOffreemploi";
    else if(nomEJB.equals("ServiceNiveauqualification"))
      nomJNDI = "java:global/cabinet_recrutement-ear/eu.telecom_bretagne.cabinet_recrutement-cabinet_recrutement-web-1.0-SNAPSHOT/ServiceNiveauqualification!eu.telecom_bretagne.cabinet_recrutement.service.IServiceNiveauqualification";
    else if(nomEJB.equals("ServiceSecteuractivite"))
      nomJNDI = "java:global/cabinet_recrutement-ear/eu.telecom_bretagne.cabinet_recrutement-cabinet_recrutement-web-1.0-SNAPSHOT/ServiceSecteuractivite!eu.telecom_bretagne.cabinet_recrutement.service.IServiceSecteuractivite";
...
//      nomJNDI = "java:global/CabinetRecrutement/CabinetRecrutement_EJB/EntrepriseDAO!eu.telecom_bretagne.cabinet_recrutement.data.dao.EntrepriseDAO";
        ...
        nomJNDI = "java:global/cabinet_recrutement-ear/eu.telecom_bretagne.cabinet_recrutement-cabinet_recrutement-web-1.0-SNAPSHOT/CandidatureDAO";
